...
const GridDistortion: React.FC<GridDistortionProps> = ({
    ...
    const handleResize = () => {
      ...
      if (plane) {
        ...
        if (containerAspect > imageAspect) {
          // Container is wider than the image: scale to fill height and overflow horizontally
          plane.scale.set(containerAspect, containerAspect / imageAspect, 1);
        } else {
          // Container is narrower (or equal): scale to image aspect and fill width
  ...
  return (
    <div
      ref={containerRef}
      className={`relative overflow-hidden object-cover ${className}`}
      style={{
        width: '100%',
        height: '100%',
        minWidth: '0',

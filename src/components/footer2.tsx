...
const defaultProps: Footer2Props = {
  ...
  copyright: "© 2024 configaris.com. All rights reserved.",
  legalLinks: [
...
const Footer2 = (props: Props) => {
  ...
  return (
    <section className={cn("py-32 mx-8", className)}>
      <div className="container mx-auto">
        <footer>
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
            <div className="col-span-2 mb-8 lg:mb-0 lg:ml-10">
          ...
          <div className="mt-8 mx-8 flex flex-col justify-between gap-4 border-t border-border pt-8 text-xs font-medium text-muted-foreground md:flex-row md:items-center">
            <p>{copyright}</p>

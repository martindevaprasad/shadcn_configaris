...
export const CategoryList = ({
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            gsap.from(containerRef.current!.querySelectorAll('.logo-anim'), {
                scale: 0.95,
                opacity: 0,
                duration: 0.6,
                stagger: 0.04,
                ...
                <div className="space-y-3">
                    {categories.map((category) => (
                            ...
                            >
                                <div
                                    className={cn(
                                        "relative overflow-hidden border bg-card transition-all duration-300 ease-in-out cursor-pointer category-card",
                                        // Hover state styles

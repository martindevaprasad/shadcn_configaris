...
export default function StackFeature() {
    ...
    return (
        <section className="relative max-w-6xl mx-auto my-4 pl-10 flex items-center justify-between h-[30rem] border border-gray-200 dark:border-gray-700 bg-white dark:bg-black overflow-hidden rounded-3xl">
            ...
            <div className="w-1/2 z-10">
                ...
                <div className="flex items-center gap-3">
                    <Button variant="default">
                        <Link to={""} target="_blank"> Get Started</Link>
                    </Button>
